...
# 1. 웹페이지 설정
st.set_page_config(page_title="NOWSYSTEM 관제탑 V50", layout="wide")
    ...
    for i, row in enumerate(filtered_daily):
        ...
        if not (u_role == "마스터" and target_user != u_name):
            ...
            with c6.popover("➡️ 이슈복사"):
                # 💡 [버그 픽스] 이슈 복사 selectbox에 고유 key 추가
